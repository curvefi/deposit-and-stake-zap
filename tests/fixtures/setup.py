...
def _mint(acct, wrapped_coins, wrapped_amounts_to_mint, underlying_coins, underlying_amounts_to_mint):
...
def mint_margo(margo, underlying_coins, wrapped_coins, wrapped_amounts_to_mint, underlying_amounts_to_mint):
    _mint(margo, wrapped_coins, wrapped_amounts_to_mint, underlying_coins, underlying_amounts_to_mint)


@pytest.fixture(scope="module")
def approve_margo(margo, zap, gauge, underlying_coins, wrapped_coins):
    _approve(margo, zap.address, underlying_coins, wrapped_coins)
